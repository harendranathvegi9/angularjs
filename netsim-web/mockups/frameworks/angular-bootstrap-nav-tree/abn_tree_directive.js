      ...
      return {
        ...
        link: function(scope, element, attrs) {
          var error, expand_all_parents, expand_level, for_all_ancestors, 
          	  ...
          	  select_branch, selected_branch, tree;
          ...
          console.log('expand_level = ' + expand_level);
          ...
          for_each_branch = function(f) {
            ...
            _ref = scope.treeData;
            console.log('do_f# ' + JSON.stringify(_ref));
            _results = [];
            console.log('do_f# _ref length: ' + _ref.length);
            for (_i = 0, _len = _ref.length; _i < _len; _i++) {
              root_branch = _ref[_i];
          ...
          for_each_branch(function(b, level) {
          	console.log('for_each_branch# branch: ' + JSON.stringify(b));
          	console.log('for_each_branch# level: ' + level);
            b.level = level;
